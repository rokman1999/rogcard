...
export const getFoilClass = (level) => {
  ...
  if (level >= 15) return 'bg-[length:200%_200%] bg-gradient-to-tr from-yellow-200 via-amber-400 to-yellow-600 animate-foil-shift p-[2px] shadow-[0_0_22px_rgba(250,204,21,0.8),0_0_45px_rgba(245,158,11,0.5)]';
  if (level >= 11) return 'bg-[length:200%_200%] bg-gradient-to-tr from-red-400 via-red-600 to-rose-900 animate-foil-shift p-[2px] shadow-[0_0_20px_rgba(239,68,68,0.8),0_0_40px_rgba(239,68,68,0.5)]';
...
export const getTierTextColor = (level) => {
  ...
  if (level >= 15) return 'text-yellow-300 drop-shadow-[0_0_8px_#fde047]';
  if (level >= 11) return 'text-red-400 drop-shadow-[0_0_8px_#f87171]';
